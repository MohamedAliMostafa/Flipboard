...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar:AppBar(
        title:  Text(SelectedCate==null?AppLocalizations.of(context)!.news:SelectedCate!.title),
      ...
      body:selec==1?SettingTab():SelectedCate==null ?CateWidget(CategorOnClik):HomeLayout(cateModel:SelectedCate!)
    );
  }
